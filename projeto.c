...
void funcaoB(Veiculo *lista, char placa[])
{
...
void funcaoC(Veiculo *lista)
{
    ...
    Veiculo *atual = lista;
    printf("Modelo e cor dos veiculos que as placas possuem vogal no segundo caractere e a soma de valores numericos da placa sejam numero par\n");
...
main()
{
    ...
    do
    {
        ...
        case 3:
            ...
            break;
        case 4:
            funcaoB(listaVeiculos, validarPlaca);
            break;
        case 5:
