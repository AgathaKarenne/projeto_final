...
void funcaoA(Veiculo *lista)
{
    ...
    while (atual != NULL)
    {
        ...
        {
            printf("nao existe nenhum proprietario com esses requisitos.\n");
        }
...
void funcaoB(Veiculo *lista)
{
    ...
    while (atual != NULL)
    {
        ...
        {
            printf("nao existe nenhuma placa que atenda a esses requisitos\n");
        }
...
{
    Veiculo *atual = lista;
    printf("Modelo e cor dos veículos que as placas possuem vogal no segundo caractere e a soma de valores numericos da placa seja numero par\n");
    ...
    while (atual != NULL)
    {
        ...
        {
            printf("nao exite nenhuma placa que atenta a esses criterios\n");
        }
